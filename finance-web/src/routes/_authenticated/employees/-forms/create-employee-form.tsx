...
const employeeSchema = z.object({
  individual: z.object({
    socialSecurityNumber: z
      ...
      .min(1, { message: "" }),
    firstName: z
      .string(FieldErrorMessage("Ad"))
      .min(1, { message: FieldErrorMessage("Ad").required_error }),
    lastName: z
      .string(FieldErrorMessage("Soyad"))
      .min(1, { message: FieldErrorMessage("Soyad").required_error }),
  ...
  officialEmploymentStartDate: z.date(
    FieldErrorMessage("Resmi işe başlama tarihi")
  ),
  salary: z.object({
    amount: z
      .number(FieldErrorMessage("Maaş tutarı"))
...
export function CreateEmployeeForm(props: CreateEmployeeFormProps) {
  ...
  const form = useForm({
    ...
    transformValues: (values) => {
      ...
      res.officialEmploymentStartDate = FormatISODate(
        res.officialEmploymentStartDate
      );
